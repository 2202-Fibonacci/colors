...
function getServiceAlerts(trainLine, onlyActive = false) {
          ...
          resp.on("end", () => {
            ...
            feed.entity.forEach((entity) => {
              if (
                ...
                const activePeriodText = active
                  ? active.translation[0].text
                  : "";
                alerts.push({
                  type: entity.alert["transit_realtime.mercury_alert"]
                    .alert_type,
...
// -> pass in train line, optional second parameter to filter by currently active alerts (true or false)
Promise.resolve(getServiceAlerts("Z", true)).then((alerts) =>
  console.log(alerts)
);
